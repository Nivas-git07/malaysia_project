...
import { get_profile } from "../../../athleteadmin/api/profile_api";

// import SkeletonLoader from "../common/SkeletonLoader";

// import ErrorState from "../common/ErrorState";
import SkeletonLoader from "../../../athleteadmin/components/common/SkeletonLoader";
import ErrorState from "../../../athleteadmin/components/common/ErrorState";
  ...
  useEffect(() => {
    if (data?.data) {
      ...
      setForm({
        ...
        expert_discipline: p.expert_discipline || "",
  ...
  return (
    <div className="athleteProfile__page">
      <div className="athleteProfile__header">
        ...
        <h1 className="athleteProfile__title">Coach Settings</h1>
      </div>
      ...
      <div className="athleteProfile__layout">
        <div className="athleteProfile__card">
          ...
          <div className="athleteProfile__meta">
            ...
            <div className="athleteProfile__metaItem">
              <p className="athleteProfile__label">EXPERTISE</p>

              <span className="athleteProfile__value">
                {form.expert_discipline || "-"}
              </span>
            </div>
          </div>
        </div>
        ...
        <div className="athleteProfile__form">
          ...
          <div className="athleteProfile__formGrid">
            ...
            <div className="athleteProfile__group">
              <label>EXPERT DISCIPLINE</label>

              <select
                name="expert_discipline"
                value={form.expert_discipline || ""}
                onChange={handleChange}
