...
import { fetch_one_news } from "../../api/home_api";
import OneNewsCenter from "../../components/newscomponent/fetchonenews";
export default function OneNews() {
  ...
  const {
    ...
    queryKey: ["fetch_one_news", id],
    queryFn: () => fetch_one_news(id),
    enabled: !!id,
