...
export const athelete_register = (full_name, gov_id, email_id, phone_number, role, gender, date_of_birth, state, password) =>{
    console.log(full_name, gov_id, email_id, phone_number, role , gender, date_of_birth, state, password); 
    API.post("/auth/athlette_register/", { gov_id, email_id, full_name, phone_number, role, gender, date_of_birth, state, password })
}
