...
export default function StateNetworkX() {
  ...
  const stateCoordsMap = {
    ...
    Selangor: {
      polyCoords: [ "205,453,262,464,305,458,328,471,328,510,312,512,319,527,302,529,287,539,251,509", ],
    },
    Perak: {
      polyCoords: [ "277,379,314,353,345,356,372,356,400,356,415,349,437,371,432,383,433,405,449,412,460,413,466,429,472,437,455,445,432,448,410,455,391,459,369,467,358,470,342,477,305,451", ]
    },
    "Tunk-Jayra": {
      polyCoords: [ "346,488,365,478,393,474,413,467,432,460,447,452,466,453,479,441,470,467,479,475,491,453,484,467,488,480,496,494,502,510,498,526,498,544,510,560,521,574,525,594,461,586,377,520,342,510", ],
    },
    "Kuala Lumpur": {
      polyCoords: [ "283,569,300,544,325,535,340,528,357,527,367,532,384,559,404,550,389,536,348,580,313,597,377,558,389,566,404,567,301,595", ],
    },
    Melaka: {
      polyCoords: [ "340,616,338,584,361,579,371,575,392,570,407,574,428,577,408,645,424,653,351,649,348,665,415,668", ],
    },
    "Negeri Sembilan": {
      polyCoords: [ "422,643,419,619,426,592,438,586,457,593,472,597,492,597,506,608,523,613,538,603,541,616,547,635,557,645,570,657,568,669,590,679,591,703,519,694,509,700", ],
    },
    Kelantan: {
      polyCoords: [ "275,343,303,278,317,221,355,180,383,212,409,233,437,255,488,312,503,371,501,408,466,436,418,344,365,365,355,353,281,371", ],
    },
    Perlis: {
      polyCoords: [ "210,276,248,244,285,223,310,276,286,294,275,332,206,314,187,302,275,318,161,320,200,330,231,332,254,332,268,330,172,314", ],
    },
  };
          ...
          <div className="mfsaStateX-list">
            {mergedStates.map((item) => (
              <div
                ...
                onClick={() => navigate(`/user/state/${item.id}`)}
              >
